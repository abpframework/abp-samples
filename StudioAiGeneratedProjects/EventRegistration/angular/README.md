# EventRegistration - Angular Application
...
Before running the Angular application, make sure your backend API is running. Start the `EventRegistration` application.
