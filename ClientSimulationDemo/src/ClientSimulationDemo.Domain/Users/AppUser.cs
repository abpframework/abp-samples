...
namespace ClientSimulationDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ClientSimulationDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ClientSimulationDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
