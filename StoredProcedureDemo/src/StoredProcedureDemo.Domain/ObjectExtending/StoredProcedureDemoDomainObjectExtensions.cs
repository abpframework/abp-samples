...
namespace StoredProcedureDemo.ObjectExtending
{
    public static class StoredProcedureDemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the StoredProcedureDemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
