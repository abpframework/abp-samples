...
namespace ConcurrencyDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ConcurrencyDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ConcurrencyDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
