...
public static class EfCoreJSONColumnDemoEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE EfCoreJSONColumnDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
