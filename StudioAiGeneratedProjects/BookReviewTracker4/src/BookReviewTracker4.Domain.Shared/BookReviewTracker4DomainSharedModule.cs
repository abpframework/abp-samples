...
public class BookReviewTracker4DomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BookReviewTracker4GlobalFeatureConfigurator.Configure();
        BookReviewTracker4ModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BookReviewTracker4DomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BookReviewTracker4Resource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/BookReviewTracker4");

            options.DefaultResourceType = typeof(BookReviewTracker4Resource);
        ...
        {
            options.MapCodeNamespace("BookReviewTracker4", typeof(BookReviewTracker4Resource));
        });
    }
}
