...
{
    public static class CustomNgAppWithIdentityServerEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE CustomNgAppWithIdentityServerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
