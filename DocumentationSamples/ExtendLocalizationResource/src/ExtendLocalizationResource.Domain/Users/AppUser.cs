...
namespace ExtendLocalizationResource.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ExtendLocalizationResourceDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ExtendLocalizationResourceEfCoreEntityExtensionMappings to extend the IdentityUser entity
