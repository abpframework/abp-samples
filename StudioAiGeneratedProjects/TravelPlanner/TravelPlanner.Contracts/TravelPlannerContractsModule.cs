...
public class TravelPlannerContractsModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TravelPlannerContractsModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TravelPlannerResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/TravelPlanner");

            options.DefaultResourceType = typeof(TravelPlannerResource);
        ...
        {
            options.MapCodeNamespace("TravelPlanner", typeof(TravelPlannerResource));
        });
    }
}
