...
public class MongoDbRecipeOrganizerDbSchemaMigrator : IRecipeOrganizerDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbRecipeOrganizerDbSchemaMigrator(IServiceProvider serviceProvider)
    {
