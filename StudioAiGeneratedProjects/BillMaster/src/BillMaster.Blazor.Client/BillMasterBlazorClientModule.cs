...
[DependsOn(
    ...
    typeof(BillMasterHttpApiClientModule)
)]
public class BillMasterBlazorClientModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(BillMasterBlazorClientModule).Assembly;
