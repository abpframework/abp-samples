...
public class EventRegistrationDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EventRegistrationDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
