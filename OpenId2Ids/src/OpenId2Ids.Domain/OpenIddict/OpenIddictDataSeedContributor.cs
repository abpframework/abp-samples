...
namespace OpenId2Ids.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("OpenId2Ids") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor
            {
                Name = "OpenId2Ids",
                DisplayName = "OpenId2Ids API",
                Resources =
                {
                    "OpenId2Ids"
                }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            /* OpenId2Ids_Web client is only needed if you created a tiered
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["OpenId2Ids_Web:ClientSecret"] ?? "1q2w3e*",
        ...
        {
            var consoleAndAngularClientRootUrl = configurationSection["OpenId2Ids_App:RootUrl"]?.TrimEnd('/');
            await CreateApplicationAsync(
        ...
        var blazorServerTieredClientId = configurationSection["OpenId2Ids_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["OpenId2Ids_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["OpenId2Ids_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode,
                    OpenIddictConstants.GrantTypes.Implicit
