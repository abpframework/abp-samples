...
namespace ExcelIO.EntityFrameworkCore
{
     ...
     */
    public class ExcelIOMigrationsDbContext : AbpDbContext<ExcelIOMigrationsDbContext>
    {
        public ExcelIOMigrationsDbContext(DbContextOptions<ExcelIOMigrationsDbContext> options) 
            : base(options)
        {
