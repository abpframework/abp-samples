...
namespace BookReviewTracker4.Web.HealthChecks;

public class BookReviewTracker4DatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BookReviewTracker4DatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
