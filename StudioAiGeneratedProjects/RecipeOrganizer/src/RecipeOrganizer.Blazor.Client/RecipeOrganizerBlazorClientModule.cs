...
[DependsOn(
    ...
    typeof(RecipeOrganizerHttpApiClientModule)
)]
public class RecipeOrganizerBlazorClientModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(RecipeOrganizerBlazorClientModule).Assembly;
