...
namespace AngularMaterialUIDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AngularMaterialUIDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AngularMaterialUIDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
