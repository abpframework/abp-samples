...
public class MongoDbMovieCollectionAppDbSchemaMigrator : IMovieCollectionAppDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbMovieCollectionAppDbSchemaMigrator(IServiceProvider serviceProvider)
    {
