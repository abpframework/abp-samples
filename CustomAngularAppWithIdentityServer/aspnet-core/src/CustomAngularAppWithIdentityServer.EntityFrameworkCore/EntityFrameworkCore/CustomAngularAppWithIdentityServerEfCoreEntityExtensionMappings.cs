...
{
    public static class CustomAngularAppWithIdentityServerEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE CustomAngularAppWithIdentityServerModuleExtensionConfigurator CLASS (in the Domain.Shared project)
