...
public class QuickBillsDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        QuickBillsGlobalFeatureConfigurator.Configure();
        QuickBillsModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<QuickBillsDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<QuickBillsResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/QuickBills");

            options.DefaultResourceType = typeof(QuickBillsResource);
        ...
        {
            options.MapCodeNamespace("QuickBills", typeof(QuickBillsResource));
        });
    }
}
