...
public class SwaggerDemoMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public SwaggerDemoMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<SwaggerDemoResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                SwaggerDemoMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
