...
public static class TelerikBlazorSampleEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE TelerikBlazorSampleModuleExtensionConfigurator CLASS (in the Domain.Shared project)
