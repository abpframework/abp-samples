...
* Check the `ConnectionStrings` in `appsettings.json` file under the `GymWorkoutPlanner` project and change it if you need.
...
* `GymWorkoutPlanner`: ASP.NET Core API host application.
...
> `9a33a832-496b-4ac7-b026-e1812a95bdb6` is the password of the certificate, you can change it to any password you want.
