...
{
    public static class ClientSimulationDemoEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE ClientSimulationDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
