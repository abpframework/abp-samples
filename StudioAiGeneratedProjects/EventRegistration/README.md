...
* Check the `ConnectionStrings` in `appsettings.json` file under the `EventRegistration` project and change it if you need.
...
* `EventRegistration`: ASP.NET Core API host application.
...
> `208fbfb8-17f5-48ea-893b-1ba020ef367d` is the password of the certificate, you can change it to any password you want.
