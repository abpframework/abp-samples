...
namespace PostgeSqlDemo.ObjectExtending
{
    public static class PostgeSqlDemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the PostgeSqlDemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
