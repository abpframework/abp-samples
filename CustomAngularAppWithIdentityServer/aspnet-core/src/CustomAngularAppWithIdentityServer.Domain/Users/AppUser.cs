...
namespace CustomAngularAppWithIdentityServer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CustomAngularAppWithIdentityServerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CustomAngularAppWithIdentityServerEfCoreEntityExtensionMappings to extend the IdentityUser entity
