...
namespace NG.ModularCRM.HealthChecks;

public class ModularCRMDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ModularCRMDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
