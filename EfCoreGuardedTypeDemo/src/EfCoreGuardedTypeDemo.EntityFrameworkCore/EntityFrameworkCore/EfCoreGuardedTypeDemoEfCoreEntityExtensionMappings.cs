...
public static class EfCoreGuardedTypeDemoEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE EfCoreGuardedTypeDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
