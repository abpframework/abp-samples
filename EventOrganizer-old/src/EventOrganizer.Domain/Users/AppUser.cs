...
namespace EventOrganizer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update EventOrganizerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update EventOrganizerEfCoreEntityExtensionMappings to extend the IdentityUser entity
