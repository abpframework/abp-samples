...
namespace SignalRDemoBlazorUi.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("SignalRDemoBlazorUi") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "SignalRDemoBlazorUi", DisplayName = "SignalRDemoBlazorUi API", Resources = { "SignalRDemoBlazorUi" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var blazorClientId = configurationSection["SignalRDemoBlazorUi_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["SignalRDemoBlazorUi_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["SignalRDemoBlazorUi_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["SignalRDemoBlazorUi_Swagger:RootUrl"]?.TrimEnd('/');
