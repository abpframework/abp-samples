...
{
    public static class ExtendLocalizationResourceEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE ExtendLocalizationResourceModuleExtensionConfigurator CLASS (in the Domain.Shared project)
