...
public class DemoCenterAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public DemoCenterAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
