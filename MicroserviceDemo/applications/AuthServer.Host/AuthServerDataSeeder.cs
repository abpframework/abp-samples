    ...
    public class AuthServerDataSeeder : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateClientsAsync()
        {
            ...
            await CreateClientAsync(
                ...
                redirectUri: "https://localhost:51954/signin-oidc",
                postLogoutRedirectUri: "https://localhost:51954/signout-callback-oidc"
            );
            ...
            await CreateClientAsync(
                ...
                new[] { "hybrid" },
                commonSecret,
                redirectUri: "https://localhost:53435/signin-oidc",
                postLogoutRedirectUri: "https://localhost:53435/signout-callback-oidc"
            );
