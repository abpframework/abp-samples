...
public class DemoCenterAppDbMigrationService : ITransientDependency
{
    public ILogger<DemoCenterAppDbMigrationService> Logger { get; set; }
    ...
    public DemoCenterAppDbMigrationService(
        ...
        IEnumerable<IDemoCenterAppDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<DemoCenterAppDbMigrationService>.Instance;
    }
