using ModularCrm.Ordering.Blazor;
using ModularCrm.Ordering;
using ModularCrm.Catalog.Blazor;
...
[DependsOn(
    ...
    typeof(ModularCrmContractsModule),
...
public class ModularCrmModule : AbpModule
{
    ...
    private void ConfigureBundles(IHostEnvironment hostingEnvironment)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            globalStyles.AddContributors(typeof(ModularCrmStyleBundleContributor));

            var globalScripts = options.ScriptBundles.Get(BlazorWebAssemblyStandardBundles.Scripts.Global);
            globalScripts.AddContributors(typeof(ModularCrmScriptBundleContributor));
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(ModularCrmModule).Assembly;
            options.AdditionalAssemblies.Add(typeof(ModularCrmClientModule).Assembly);
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new ModularCrmMenuContributor(context.Services.GetConfiguration()));
        });
    }
