...
using TaskAndCommentBoard.Data;
using TaskAndCommentBoard.Localization;
using TaskAndCommentBoard.Menus;
using TaskAndCommentBoard.Permissions;
using TaskAndCommentBoard.HealthChecks;
...
public class TaskAndCommentBoardModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(TaskAndCommentBoardResource)
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("TaskAndCommentBoard");
    ...
    {
        context.Services.AddTaskAndCommentBoardHealthChecks();
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<TaskAndCommentBoardResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/TaskAndCommentBoard");

            options.DefaultResourceType = typeof(TaskAndCommentBoardResource);
        ...
        {
            options.MapCodeNamespace("TaskAndCommentBoard", typeof(TaskAndCommentBoardResource));
        });
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<TaskAndCommentBoardModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<TaskAndCommentBoardModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(TaskAndCommentBoardModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "TaskAndCommentBoard API", Version = "v1" });
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new TaskAndCommentBoardMenuContributor());
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new TaskAndCommentBoardToolbarContributor());
        });
    }
    
    private void ConfigureEfCore(ServiceConfigurationContext context)
    {
        context.Services.AddAbpDbContext<TaskAndCommentBoardDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "TaskAndCommentBoard API");
        });
