...
{
    public static class UnifiedContextsDemoEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE UnifiedContextsDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
