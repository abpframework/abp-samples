...
namespace SignalRDemo.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SignalRDemoDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SignalRDemoEfCoreEntityExtensionMappings to extend the IdentityUser entity
