...
namespace GymWorkoutPlanner.Migrations
{
    /// <inheritdoc />
    public partial class InitialRecreatePostgreSql : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    TargetMuscleGroup = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppWorkoutPlanExercises_AppExercises_ExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlanExercises_WorkoutPlanId_ExerciseId_Order",
                table: "AppWorkoutPlanExercises",
                columns: new[] { "WorkoutPlanId", "ExerciseId", "Order" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkoutPlanExercises_WorkoutPlanId_Order",
                table: "AppWorkoutPlanExercises",
