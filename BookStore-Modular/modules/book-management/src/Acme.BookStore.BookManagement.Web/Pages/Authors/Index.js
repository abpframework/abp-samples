$(function () {
    ...
    var dataTable = $('#AuthorsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(acme.bookStore.bookManagement.author.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                            ...
                            [
                                {
                                    text: l('Edit'),
                                    visible:
                                        abp.auth.isGranted('BookManagement.Authors.Edit'),
                                ...
                                },
                                {
                                    text: l('Delete'),
                                    visible:
                                        abp.auth.isGranted('BookManagement.Authors.Delete'),
