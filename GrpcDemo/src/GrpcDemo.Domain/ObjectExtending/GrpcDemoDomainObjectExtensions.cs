...
namespace GrpcDemo.ObjectExtending
{
    public static class GrpcDemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the GrpcDemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
