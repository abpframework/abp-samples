...
{
    [DbContext(typeof(CustomNgAppWithIdentityServerMigrationsDbContext))]
    partial class CustomNgAppWithIdentityServerMigrationsDbContextModelSnapshot : ModelSnapshot
    {
