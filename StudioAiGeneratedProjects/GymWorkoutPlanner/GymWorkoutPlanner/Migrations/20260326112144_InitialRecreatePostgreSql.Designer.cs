...
{
    [DbContext(typeof(GymWorkoutPlannerDbContext))]
    [Migration("20260326112144_InitialRecreatePostgreSql")]
    partial class InitialRecreatePostgreSql
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymWorkoutPlanner.Entities.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GymWorkoutPlanner.Entities.Exercises.Exercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GymWorkoutPlanner.Entities.WorkoutPlans.WorkoutPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GymWorkoutPlanner.Entities.WorkoutPlans.WorkoutPlanExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkoutPlanId", "ExerciseId", "Order")
                        .IsUnique();
            ...
            modelBuilder.Entity("GymWorkoutPlanner.Entities.WorkoutPlans.WorkoutPlanExercise", b =>
                {
                    b.HasOne("GymWorkoutPlanner.Entities.Exercises.Exercise", null)
                        .WithMany()
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GymWorkoutPlanner.Entities.WorkoutPlans.WorkoutPlan", null)
                        .WithMany()
