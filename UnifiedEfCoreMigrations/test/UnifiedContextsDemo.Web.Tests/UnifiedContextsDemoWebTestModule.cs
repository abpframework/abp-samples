...
namespace UnifiedContextsDemo
{
    [DependsOn(
        ...
        typeof(UnifiedContextsDemoWebModule),
        typeof(UnifiedContextsDemoApplicationTestModule)
    )]
    public class UnifiedContextsDemoWebTestModule : AbpModule
    {
        ...
        private static void ConfigureLocalizationServices(IServiceCollection services)
        {
            ...
            {
                options.Resources
                    .Get<UnifiedContextsDemoResource>()
                    .AddBaseTypes(
