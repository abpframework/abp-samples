...
namespace SignInWithoutSpecifyingTenant.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update SignInWithoutSpecifyingTenantDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update SignInWithoutSpecifyingTenantEfCoreEntityExtensionMappings to extend the IdentityUser entity
