...
{
    [DbContext(typeof(BookReviewTracker4DbContext))]
    [Migration("20260406113125_AddAuthorBookReviewEntities")]
    partial class AddAuthorBookReviewEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookReviewTracker4.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookReviewTracker4.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuthorId")
                        .HasDatabaseName("IX_AppBooks_AuthorId");

                    b.ToTable("AppBooks", (string)null);
                });

            modelBuilder.Entity("BookReviewTracker4.Books.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("BookId")
                        .HasDatabaseName("IX_AppReviews_BookId");
            ...
            modelBuilder.Entity("BookReviewTracker4.Books.Book", b =>
                {
                    b.HasOne("BookReviewTracker4.Authors.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("BookReviewTracker4.Books.Review", b =>
                {
                    b.HasOne("BookReviewTracker4.Books.Book", "Book")
                        .WithMany("Reviews")
