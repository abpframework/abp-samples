...
public class GymWorkoutPlannerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public GymWorkoutPlannerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
