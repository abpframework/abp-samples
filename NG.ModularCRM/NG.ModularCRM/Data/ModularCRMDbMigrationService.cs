...
public class ModularCRMDbMigrationService : ITransientDependency
{
    ...
    private async Task SeedDataAsync(Tenant? tenant = null)
    {
        ...
        await _dataSeeder.SeedAsync(new DataSeedContext(tenant?.Id)
            .WithProperty(IdentityDataSeedContributor.AdminEmailPropertyName, ModularCRMConsts.AdminEmailDefaultValue)
            .WithProperty(IdentityDataSeedContributor.AdminPasswordPropertyName, ModularCRMConsts.AdminPasswordDefaultValue)
        );
    }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "NG.ModularCRM");
    }
