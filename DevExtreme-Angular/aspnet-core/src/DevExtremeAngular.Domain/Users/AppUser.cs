...
namespace DevExtremeAngular.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DevExtremeAngularDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DevExtremeAngularEfCoreEntityExtensionMappings to extend the IdentityUser entity
