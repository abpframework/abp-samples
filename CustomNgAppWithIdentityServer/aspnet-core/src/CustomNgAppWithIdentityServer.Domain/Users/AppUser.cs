...
namespace CustomNgAppWithIdentityServer.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. update CustomNgAppWithIdentityServerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CustomNgAppWithIdentityServerEfCoreEntityExtensionMappings to extend the IdentityUser entity
