...
namespace SignalRDemo.ObjectExtending
{
    public static class SignalRDemoDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the SignalRDemoEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
