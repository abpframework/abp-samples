...
namespace ProfilerTiered.Web.Menus
{
    public class ProfilerTieredMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public ProfilerTieredMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<ProfilerTieredResource>();

            context.Menu.Items.Insert(
                0,
                new ApplicationMenuItem(
                    ProfilerTieredMenus.Home,
                    l["Menu:Home"],
                    "~/",
                    icon: "fas fa-home",
                    order: 0
