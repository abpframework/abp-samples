...
using GymWorkoutPlanner.Data;
using GymWorkoutPlanner.Localization;
using GymWorkoutPlanner.HealthChecks;
...
public class GymWorkoutPlannerModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(GymWorkoutPlannerResource)
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("GymWorkoutPlanner");
    ...
    {
        context.Services.AddGymWorkoutPlannerHealthChecks();
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<GymWorkoutPlannerResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/GymWorkoutPlanner");

            options.DefaultResourceType = typeof(GymWorkoutPlannerResource);
        ...
        {
            options.MapCodeNamespace("GymWorkoutPlanner", typeof(GymWorkoutPlannerResource));
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(GymWorkoutPlannerModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        services.AddAbpSwaggerGenWithOAuth(
            ...
            {
                {"GymWorkoutPlanner", "GymWorkoutPlanner API"}
            },
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "GymWorkoutPlanner API", Version = "v1" });
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("GymWorkoutPlanner");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<GymWorkoutPlannerModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<GymWorkoutPlannerModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<GymWorkoutPlannerDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "GymWorkoutPlanner API");
