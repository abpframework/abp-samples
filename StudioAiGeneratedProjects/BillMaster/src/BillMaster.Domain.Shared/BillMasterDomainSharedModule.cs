...
public class BillMasterDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        BillMasterGlobalFeatureConfigurator.Configure();
        BillMasterModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<BillMasterDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<BillMasterResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/BillMaster");

            options.DefaultResourceType = typeof(BillMasterResource);
        ...
        {
            options.MapCodeNamespace("BillMaster", typeof(BillMasterResource));
        });
    }
}
