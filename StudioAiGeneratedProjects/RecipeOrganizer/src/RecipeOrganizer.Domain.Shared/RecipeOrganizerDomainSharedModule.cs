...
public class RecipeOrganizerDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        RecipeOrganizerGlobalFeatureConfigurator.Configure();
        RecipeOrganizerModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<RecipeOrganizerDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<RecipeOrganizerResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/RecipeOrganizer");

            options.DefaultResourceType = typeof(RecipeOrganizerResource);
        ...
        {
            options.MapCodeNamespace("RecipeOrganizer", typeof(RecipeOrganizerResource));
        });
    }
}
