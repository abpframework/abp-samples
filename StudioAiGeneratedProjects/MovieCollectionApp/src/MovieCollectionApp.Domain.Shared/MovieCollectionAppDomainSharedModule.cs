...
public class MovieCollectionAppDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MovieCollectionAppGlobalFeatureConfigurator.Configure();
        MovieCollectionAppModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MovieCollectionAppDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MovieCollectionAppResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MovieCollectionApp");

            options.DefaultResourceType = typeof(MovieCollectionAppResource);
        ...
        {
            options.MapCodeNamespace("MovieCollectionApp", typeof(MovieCollectionAppResource));
        });
    }
}
