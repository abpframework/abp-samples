...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3b2fe815-48e0-4f4c-8bf2-f327d358e710
```

> `3b2fe815-48e0-4f4c-8bf2-f327d358e710` is the password of the certificate, you can change it to any password you want.
