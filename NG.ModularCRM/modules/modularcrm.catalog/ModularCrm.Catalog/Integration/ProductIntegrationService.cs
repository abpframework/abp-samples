...
public class ProductIntegrationService : CatalogAppService, IProductIntegrationService
{
    ...
    {
        var products = await _productRepository.GetListAsync(product => ids.Contains(product.Id));
