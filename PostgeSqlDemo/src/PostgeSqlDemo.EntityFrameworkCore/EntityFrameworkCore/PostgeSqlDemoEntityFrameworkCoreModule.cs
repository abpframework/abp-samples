...
{
    [DependsOn(
        typeof(PostgeSqlDemoDomainModule),
    ...
    public class PostgeSqlDemoEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<PostgeSqlDemoDbContext>(options =>
            {
