...
{
    [DbContext(typeof(BillMasterDbContext))]
    partial class BillMasterDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BillMaster.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BillMaster.Invoices.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BillMaster.Invoices.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BillMaster.Invoices.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BillMaster.Invoices.Invoice", b =>
                {
                    b.HasOne("BillMaster.Invoices.Customer", "Customer")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("BillMaster.Invoices.InvoiceItem", b =>
                {
                    b.HasOne("BillMaster.Invoices.Invoice", "Invoice")
                        .WithMany("Items")
