...
* Check the `ConnectionStrings` in `appsettings.json` file under the `NG.ModularCRM` project and change it if you need.
...
* `NG.ModularCRM`: ASP.NET Core API host application.
...
> `e0988568-87cf-4274-b062-b33752ad11a5` is the password of the certificate, you can change it to any password you want.
