...
public class MovieCollectionAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MovieCollectionAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
