...
public class aspnetModule : AbpModule
{
    ...
    {
        context.Services.AddaspnetHealthChecks();
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<aspnetResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/aspnet");

            options.DefaultResourceType = typeof(aspnetResource);
        ...
        {
            options.MapCodeNamespace("aspnet", typeof(aspnetResource));
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(aspnetModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services, IConfiguration configuration)
    {
        services.AddAbpSwaggerGenWithOAuth(
            ...
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "aspnet API", Version = "v1" });
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("aspnet");
    }
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<aspnetModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<aspnetModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<aspnetDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "aspnet API");
