...
public class PersonalBudgetDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public PersonalBudgetDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
