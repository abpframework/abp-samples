...
namespace DevExtreme.Sample.ObjectExtending
{
    public static class SampleDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the SampleEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
