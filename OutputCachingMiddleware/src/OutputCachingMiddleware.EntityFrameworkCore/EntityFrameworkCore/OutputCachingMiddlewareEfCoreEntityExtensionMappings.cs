...
public static class OutputCachingMiddlewareEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE OutputCachingMiddlewareModuleExtensionConfigurator CLASS (in the Domain.Shared project)
