...
namespace CustomApplicationModules.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CustomApplicationModulesDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CustomApplicationModulesEfCoreEntityExtensionMappings to extend the IdentityUser entity
