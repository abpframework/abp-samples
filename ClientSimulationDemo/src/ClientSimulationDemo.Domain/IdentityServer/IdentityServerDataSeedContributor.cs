...
namespace ClientSimulationDemo.IdentityServer
{
    public class IdentityServerDataSeedContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateApiResourcesAsync()
        {
            ...
            await CreateApiResourceAsync("ClientSimulationDemo", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            //Web Client
            var webClientId = configurationSection["ClientSimulationDemo_Web:ClientId"];
            ...
            // Blazor Client
            var blazorClientId = configurationSection["ClientSimulationDemo_Blazor:ClientId"];
            if (!blazorClientId.IsNullOrWhiteSpace())
            {
                var blazorRootUrl = configurationSection["ClientSimulationDemo_Blazor:RootUrl"].TrimEnd('/');
