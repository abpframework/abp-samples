...
{
    public class SyncfusionSampleTenantDatabaseMigrationHandler :
        ...
        ITransientDependency
    {
        ...
        private readonly ILogger<SyncfusionSampleTenantDatabaseMigrationHandler> _logger;

        public SyncfusionSampleTenantDatabaseMigrationHandler(
            IEnumerable<ISyncfusionSampleDbSchemaMigrator> dbSchemaMigrators,
            ICurrentTenant currentTenant,
            IUnitOfWorkManager unitOfWorkManager,
            IDataSeeder dataSeeder,
            ITenantStore tenantStore,
            ILogger<SyncfusionSampleTenantDatabaseMigrationHandler> logger)
        {
        ...
        public async Task HandleEventAsync(TenantCreatedEto eventData)
        {
            await MigrateAndSeedForTenantAsync(
                eventData.Id,
                eventData.Properties.GetOrDefault("AdminEmail") ?? SyncfusionSampleConsts.AdminEmailDefaultValue,
                eventData.Properties.GetOrDefault("AdminPassword") ?? SyncfusionSampleConsts.AdminPasswordDefaultValue
            );
        }
