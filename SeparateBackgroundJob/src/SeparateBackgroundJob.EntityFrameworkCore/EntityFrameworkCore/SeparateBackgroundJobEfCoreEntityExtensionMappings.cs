...
public static class SeparateBackgroundJobEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE SeparateBackgroundJobModuleExtensionConfigurator CLASS (in the Domain.Shared project)
