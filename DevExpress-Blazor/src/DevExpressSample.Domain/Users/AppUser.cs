...
namespace DevExpressSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DevExpressSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DevExpressSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
