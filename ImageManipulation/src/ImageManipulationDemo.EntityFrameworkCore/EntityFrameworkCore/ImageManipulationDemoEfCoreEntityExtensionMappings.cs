...
public static class ImageManipulationDemoEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ImageManipulationDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
