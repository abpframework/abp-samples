...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        await CreateScopesAsync(new OpenIddictScopeDescriptor 
        {
            ...
            DisplayName = "GymWorkoutPlanner API", 
            Resources = { "GymWorkoutPlanner" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Angular Client
        var consoleAndAngularClientId = configurationSection["GymWorkoutPlanner_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["GymWorkoutPlanner_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["GymWorkoutPlanner_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["GymWorkoutPlanner_Swagger:RootUrl"].TrimEnd('/');
