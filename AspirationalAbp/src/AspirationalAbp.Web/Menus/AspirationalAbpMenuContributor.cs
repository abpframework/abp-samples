...
public class AspirationalAbpMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public AspirationalAbpMenuContributor(IConfiguration configuration)
    {
    ...
    private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
    {
        ...
        var l = context.GetLocalizer<AspirationalAbpResource>();

        context.Menu.Items.Insert(
            0,
            new ApplicationMenuItem(
                AspirationalAbpMenus.Home,
                l["Menu:Home"],
                "~/",
                icon: "fas fa-home",
                order: 0
