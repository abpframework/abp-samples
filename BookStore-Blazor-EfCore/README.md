...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0485aa07-477a-454d-b8db-16370c91a24a
```

> `0485aa07-477a-454d-b8db-16370c91a24a` is the password of the certificate, you can change it to any password you want.
