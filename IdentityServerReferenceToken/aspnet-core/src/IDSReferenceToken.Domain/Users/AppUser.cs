...
namespace IDSReferenceToken.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update IDSReferenceTokenDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update IDSReferenceTokenEfCoreEntityExtensionMappings to extend the IdentityUser entity
