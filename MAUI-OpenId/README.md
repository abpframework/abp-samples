...
## Integrating HttpApi.Client

// TODO: Make a request with ABP **AppServices** to get users list and list them in a ListView

// Implement `IdentityModelRemoteServiceHttpClientAuthenticator` to provide token to ABP ProxyBase
// (https://github.com/abpframework/abp/blob/0d620af7cbde3c4af88d50a550ad3c07d263081a/framework/src/Volo.Abp.Http.Client.IdentityModel.WebAssembly/Volo/Abp/Http/Client/IdentityModel/WebAssembly/AccessTokenProviderIdentityModelRemoteServiceHttpClientAuthenticator.cs#L32)

// Maybe in a part2

// Get inspired by https://github.com/hikalkan/maui-abp-playing for this section
