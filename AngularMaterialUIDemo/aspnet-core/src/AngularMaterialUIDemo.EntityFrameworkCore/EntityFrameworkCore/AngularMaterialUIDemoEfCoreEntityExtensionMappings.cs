...
{
    public static class AngularMaterialUIDemoEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AngularMaterialUIDemoModuleExtensionConfigurator CLASS (in the Domain.Shared project)
