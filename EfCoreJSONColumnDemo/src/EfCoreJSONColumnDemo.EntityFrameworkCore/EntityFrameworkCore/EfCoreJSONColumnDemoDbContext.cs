...
public class EfCoreJSONColumnDemoDbContext :
    AbpDbContext<EfCoreJSONColumnDemoDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public EfCoreJSONColumnDemoDbContext(DbContextOptions<EfCoreJSONColumnDemoDbContext> options)
        : base(options)
    {
