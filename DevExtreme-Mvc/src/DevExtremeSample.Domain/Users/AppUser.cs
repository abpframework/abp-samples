...
namespace DevExtremeSample.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DevExtremeSampleDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DevExtremeSampleEfCoreEntityExtensionMappings to extend the IdentityUser entity
